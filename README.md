...
| Modification | Files |
|---|---|
| **Polish translations** of English questions | `<source>__translations-pl.jsonl.gz` |
| **English text refinements** of upstream questions | `<source>__refinements-en.jsonl.gz` |
| **Quizifications** — Q&A pairs converted into multiple-choice or boolean questions | `<source>__quizified.jsonl.gz` |
...
_Generated by [QuizBase](https://quizbase.runriva.com) — multilingual trivia API._
